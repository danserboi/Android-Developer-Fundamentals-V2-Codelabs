...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String ACTION_CANCEL_NOTIFICATION = "" +
            "ro.danserboi.notifyme.ACTION_CANCEL_NOTIFICATION";
    private static final String ACTION_UPDATE_NOTIFICATION =
            "ro.danserboi.notifyme.ACTION_UPDATE_NOTIFICATION";
    ...
    public void updateNotification() {
        ...
        notifyBuilder.setLargeIcon(androidImage)
                ...
                .addLine("Hello, hello !")
                .addLine("What a beautiful line !")
                .setBigContentTitle("This is the big content title.")
                .setSummaryText("And we can't forget the summary text !"));
